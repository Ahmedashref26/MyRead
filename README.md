...
1. App allows user to keep track of his / her reading behavoiur by organizing books based on what the user is currently reading, what the user has read and what the user intends to read

#### different shelves(category)
   * Currently Reading
   * Want To Read
   * Read
